...
/* ---------------------------------- OVERVIEW --------------------------------- */
.overview-card { margin-bottom: 1.75rem; }
.overview-grid {
  display: grid;
...
.premium-list li::before {
  ...
  border-radius: 50%;
  background: var(--fizz);
  box-shadow: 0 0 8px 1px rgba(201,255,82,0.5);
}
...
.mt-dot { width: 7px; height: 7px; border-radius: 50%; background: var(--ice); }
.mt-label { color: var(--text); }
.mt-day { font-family: var(--font-mono); font-size: 0.72rem; color: var(--muted-dim); }
...
@media (max-width: 900px) {
  .overview-grid, .two-up, .assets-grid { grid-template-columns: 1fr; }
